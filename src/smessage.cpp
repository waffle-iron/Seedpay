// Copyright (c) 2014 The Seedpay developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Seedpay-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Seedpay-smsg-pow"); // Make this thread recognisable
