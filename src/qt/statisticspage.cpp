...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "FRESH POW (POS Starts Block 14000)";
    }
    ...
    {
		subsidy = "140000 SPY per block";
    }
	else if(pindexBest->nHeight < 160)
    {
		subsidy = "0 SPY per block";
    }
	else if(pindexBest->nHeight < 14000)
    {
		subsidy = "500 SPY per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " SPY" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " SPY" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " SPY");
    }
